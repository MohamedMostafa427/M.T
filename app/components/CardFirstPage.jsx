...
export default function CardFirstPage() {
            ...
            <div className="mx-auto flex w-full gap-8 items-center flex-wrap relative justify-center text-center">
                {items.map((e, index) =>
                    <motion.div
                        ...
                        key={index}
                    >
                        <Link href={e.services.length > 0 ? `/services/${e.id}` : `/notfoundPade`} legacyBehavior>
                            <a>
                                <div className="w-72 bg-white rounded-lg shadow-md p-6 text-center relative">
                                    ...
                                    <div className="flex justify-center items-center mb-4">
                                        <Image src={me} width={50} height={50} alt="message icon" />
                                    </div>
